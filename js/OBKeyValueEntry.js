...
let user = {
  ...
  console.log(`1 - Array of Keys-` ,Object.keys(user) );
  console.log(`2 - Array of Values-` ,Object.values(user) );
  console.log(`3 - Array of Key , Value Pairs-` ,Object.entries(user) );
  /*
...
for (let value of Object.values(user)) {
    console.log(`4 - Loop Over Property values - `,value); // John, then 30
  }
...
Usually that’s convenient. But if we want symbolic keys too, 
then there’s a separate method Object.getOwnPropertySymbols that returns an array of only symbolic keys. 
...
console.log(`5 - Prices Object - `, prices);
...
console.log(`6 - Double The Prices - `,doublePrices.meat); // 8
console.log(`7 - Double The Prices Object - `,doublePrices); // 8
//It may look difficult from the first sight, 
//but becomes easy to understand after you use it once or twice. We can make powerful chains of transforms this way.